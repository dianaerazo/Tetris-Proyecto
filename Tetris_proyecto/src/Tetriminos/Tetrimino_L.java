...
public class Tetrimino_L extends Tetrimino {
    public Tetrimino_L(int[][] dimensiones, String color, int posicion_x, int posicion_y) {
        super(dimensiones, color, posicion_x, posicion_y, "L");
        construirTetrimino();
    }
    ...
    private void construirTetrimino() {
        ...
        obtenerForma = new int[][]{{0, 0, 1}, {1, 1, 1}};
    }
