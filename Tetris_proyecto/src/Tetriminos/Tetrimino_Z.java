...
public class Tetrimino_Z extends Tetrimino {
    public Tetrimino_Z(int[][] dimensiones, String color, int posicion_x, int posicion_y) {
        super(dimensiones, color, posicion_x, posicion_y, "Z");
        construirTetrimino();
    }
    ...
    private void construirTetrimino() {
        ...
        obtenerForma = new int[][]{{1, 1, 0}, {0, 1, 1}};
    }
