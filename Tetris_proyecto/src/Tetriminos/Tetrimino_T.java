...
public class Tetrimino_T extends Tetrimino {
    public Tetrimino_T(int[][] dimensiones, String color, int posicion_x, int posicion_y) {
        super(dimensiones, color, posicion_x, posicion_y, "T");
        construirTetrimino();
    }
    ...
    private void construirTetrimino() {
        ...
        obtenerForma = new int[][]{{0, 1, 0}, {1, 1, 1}};
    }
